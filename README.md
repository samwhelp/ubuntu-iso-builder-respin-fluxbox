...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-fluxbox/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-fluxbox](https://github.com/samwhelp/ubuntu-iso-builder-respin-fluxbox)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-fluxbox.git
```


> change dir to `ubuntu-iso-builder-respin-fluxbox`

``` sh
cd ubuntu-iso-builder-respin-fluxbox
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-fluxbox/dist`
